...
struct AppInfoView: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            ...
            RowAppInfoView(ItemOne: "Developer", ItemTwo: "Ing. Ceron")
            RowAppInfoView(ItemOne: "Designer", ItemTwo: "Udemy Course")
            RowAppInfoView(ItemOne: "Website", ItemTwo: "https://www.")
